...
$pdf->AddPage();
  ...
  $maxHeight = 30; // 2.5 cm
   ...
   if (file_exists($rutaImagen)) {
      ...
      $pdf->Image($rutaImagen, $logoX + 140, $logoY + 30, $newWidth, $newHeight, '', '', false, 300);
    } else {
  ...
  $pdf->SetXY($pdf->GetX()-10, $pdf->GetY()+30); // asegura posición
  ...
  //DOMICILIO
  $pdf->SetXY($pdf->GetX()-3, $pdf->GetY()+10); // asegura posición
